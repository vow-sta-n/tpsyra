import "../App.css";
import cover from "../assets/mag/025.png";
import hor from "../assets/imgs/hor.png";
import ver from "../assets/imgs/ver.png";
import clip from "../assets/video/cli.mp4";
import fig from "../assets/video/smiling.mp4";

export default function SmilingPage() {
  return (
    <div className="w-full h-full bg-white overflow-hidden relative">
      ...
      <div className="z-50 grid grid-cols-2 h-full">
        ...
        {/* CROPPING BOX */}
        <div className="absolute bottom-0 right-2 z-20"></div>
      </div>
      <img
        src={ver}
        // autoPlay
        ...
        // playsInline
        // loop
        className="absolute bottom-8 left-10 w-[58%] pointer-events-none z-30"
      />
      <img
        src={hor}
        // autoPlay
        ...
        // playsInline
        // loop
        className="absolute bottom-8 left-10 w-[50%] h-[91%] pointer-events-none z-30"
      />
      <video
        src={fig}
        autoPlay
        ...
        playsInline
        loop
        className="absolute bottom-12 left-14 w-[50%] h-[99%] pointer-events-none z-20"
      />
      {/* Visual 1 */}
      <img
        src={cover}
